...
class SlidesAdd extends Component
{
    ...
    {
        return view('livewire.admin.slides.slides-add');
    }
    ...
    public function save()
    {
        ...
        $this->image->storeAs('images/slides', $slide->id . '.' . $this->image->extension());

        $slide->update(['image' => 'images/slides/'.$slide->id . '.' . $this->image->extension()]);
