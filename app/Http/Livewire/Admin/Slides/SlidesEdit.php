...
class SlidesEdit extends Component
{
    ...
    {
        return view('livewire.admin.slides.slides-edit');
    }
    ...
    public function save()
    {
        ...
        if ($this->image) {
            ...
            $this->image->storeAs('images/slides', $this->slide->id . '.' . $this->image->extension());
            $this->slide->update(['image' => 'images/slides/' . $this->slide->id . '.' . $this->image->extension()]);
        }
