<x-user-layout>
    <x-cards.default>
        <x-slot:header>
            <h3 class="text-lg leading-6 font-medium text-red-700"><i class="fa-solid fa-blog mr-2"></i></i>Edit Blogpost</h3>
            <p class="mt-1 text-sm text-gray-500">Edit BlogPost</p>
        </x-slot:header>
...
{{--        <form action="#" method="POST" enctype="multipart/form-data">--}}
            ...
            <div class="mt-6 space-y-5 gap-y-6 gap-x-4 sm:grid-cols-6">
                ...
                <div class="w-full">
                    <x-form.textarea name="excerpt" placeholder="Write a description...">{{ $post->excerpt }}</x-form.textarea>
                </div>

                <div class="w-full">
                    <x-form.textarea wire:model.defer="body" name="body" id="body">{{ $post->body }}</x-form.textarea>
                </div>

                <div class="w-full">
                    <img class="w-full max-h-96" src="{{asset('storage/'.$post->image)}}" alt="Post Image">
