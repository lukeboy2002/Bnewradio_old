<x-user-layout>
    <x-cards.default>
        <x-slot:header>
            <h2 id="applicant-information-title" class="text-lg leading-6 font-medium text-gray-900"><i class="fa-solid fa-folder-plus mr-2"></i>Add Role</h2>
            <p class="mt-1 max-w-2xl text-sm text-gray-500">Create a new Role</p>
        </x-slot:header>
